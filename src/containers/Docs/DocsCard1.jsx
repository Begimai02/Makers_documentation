  ...
  return (
    <div>
      {titles ?
        <>
          <div style={{
            margin: "50px auto", padding: "0", width: "100%", maxWidth: "600px", cursor: "pointer"
          }}>
            <IconButton>
          ...
          <div style={{ display: 'flex', flexWrap: "wrap", flexDirection: "row",textAlign: "center", justifyContent: "space-evenly" }}>
            {
              docs.map((item, index) => (
                <div key={index + ""}>
